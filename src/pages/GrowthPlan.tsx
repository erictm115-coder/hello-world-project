      ...
      case 39:
        const handleCreateAccount = async () => {
          ...
          if (!answers.email) {
            toast({
              title: "Error",
              description: "Email not found. Please go back and enter your email.",
              variant: "destructive",
            });
            return;
          }
          ...
          try {
            ...
            // Step 2: Calculate subscription end date based on plan
          ...
          <div key={step} className="space-y-6 animate-fade-in pb-8">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-muted/30 border border-border rounded-lg p-3">
                <p className="text-foreground">{answers.email}</p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-muted/30 border border-border rounded-lg p-3">
                <p className="text-foreground font-semibold">
                  {answers.plan === "1month" && "1 Month Plan - €11.07"}
                  {answers.plan === "3months" && "3 Months Plan - €19.98"}
                  {answers.plan === "1year" && "1 Year Plan - €49.98"}
                </p>
              </div>
            </div>
            ...
            <div className="bg-muted/20 rounded-lg p-4 space-y-2">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2 text-xs">
                  ...
                  <span className={password === confirmPassword && password.length > 0 ? "text-green-500" : "text-muted-foreground"}>
